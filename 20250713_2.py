...
if not st.session_state.logged_in:
    ...
    if st.session_state.current_quiz_id and not data[data['Unique_ID'] == st.session_state.current_quiz_id].empty:
    ...
    if st.session_state.answered is not None or not st.session_state.choices: 
        if st.button("Next! ➡️", use_container_width=True):
            # When clicking "Next!", reload data to get the very latest user progress.
            # This updated 'data' DataFrame will then be used by setup_question.
